              ...
              <div className="space-y-4 pt-1">
                <div className="bg-blue-50/80 border border-blue-200 rounded-2xl p-4 space-y-2.5">
                  ...
                  <p className="text-[11px] text-amber-800 bg-amber-50 p-2.5 rounded-xl border border-amber-200/70">
                    ℹ️ Sesuai ketentuan langganan, Anda <strong>tidak perlu dan tidak dapat membeli Paket Guru Mandiri</strong> karena sudah ditanggung oleh lisensi sekolah.
                  </p>
                </div>
                ...
                <button
                  type="button"
                  onClick={onClose}
                  className="w-full py-3 px-4 rounded-xl bg-slate-800 hover:bg-slate-900 text-white font-bold text-xs shadow-md transition flex items-center justify-center gap-2 cursor-pointer"
                >
