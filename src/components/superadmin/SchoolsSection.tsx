            ...
            <table className="w-full text-left text-xs">
              <thead>
                <tr className="border-b border-slate-200 text-slate-500 font-bold bg-slate-50/80">
                  ...
                  <th className="py-3.5 px-4 font-bold">Kode Undangan</th>
                  <th className="py-3.5 px-4 font-bold">Ruang Kerja</th>
                    ...
                    >
                      ...
                      <td className="py-3.5 px-4">
                        ...
                        >
                          {s.workspace_type === 'personal' || s.is_personal ? (
                            <>
                              <User size={11} /> Individu
                            </>
                          ) : (
                            <>
                              <Building2 size={11} /> Sekolah
                            </>
                          )}
                        </span>
                      </td>
                      ...
                      <td className="py-3.5 px-4 text-right" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-center justify-end gap-1.5">
                          ...
                          <button
                            ...
                            title="Buka Sesi Sekolah (Mode Bantuan)"
                            className="p-1.5 rounded-lg bg-indigo-50 hover:bg-indigo-100 text-indigo-700 font-bold text-xs cursor-pointer transition-colors"
                          >
