...
/**
 * Mengecek apakah pengguna atau sekolahnya saat ini sedang aktif berlangganan Paket Sekolah Pro.
 * Aturan Sistem:
 * - Pengguna di Paket Sekolah aktif (Admin & Seluruh Guru) TIDAK DIPERKENANKAN membeli Paket Guru.
 * - Jika masa aktif Paket Sekolah telah berakhir (Expired), sistem mengembalikan false (kembali ke paket gratis),
 *   sehingga pengguna/guru diperbolehkan upgrade ke Paket Guru atau memperpanjang Paket Sekolah.
 */
export function isUserInActiveSchoolPlan(
  ...
  // Jika masa aktif sudah terlewat, status kembali ke paket gratis (aturan kembali ke awal)
