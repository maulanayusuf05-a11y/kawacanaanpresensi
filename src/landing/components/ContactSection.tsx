...
export const ContactSection: React.FC<ContactSectionProps> = ({ lang, onOpenRegister }) => {
  ...
  return (
    <section id="kontak" className="py-16 sm:py-20 lg:py-24 bg-white text-slate-900 relative border-b border-blue-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-left max-w-3xl space-y-4 mb-12 sm:mb-16">
          ...
          <div className="pt-2 flex flex-wrap items-center gap-3 sm:gap-4">
            <a
              href="#form-kontak"
              className="px-6 py-3.5 bg-blue-700 hover:bg-blue-800 text-white font-bold text-xs uppercase tracking-wider transition-all rounded-lg shadow-sm inline-flex items-center gap-2 cursor-pointer"
            >
            ...
            <button
              ...
              className="px-6 py-3.5 bg-white border border-blue-200 hover:border-blue-700 text-blue-900 font-bold text-xs uppercase tracking-wider transition-all rounded-lg shadow-xs inline-flex items-center gap-2 cursor-pointer"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-8 space-y-8 shadow-xs">
              <div>
                ...
                <h3 className="text-xl font-black uppercase tracking-tight text-[#0B2F64]">
              ...
              <div className="space-y-6 text-sm text-slate-700">
                <div className="flex items-start gap-4">
                  <div className="w-11 h-11 rounded-lg bg-emerald-50 border border-emerald-200 text-emerald-700 flex items-center justify-center shrink-0">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-11 h-11 rounded-lg bg-blue-50 border border-blue-200 text-blue-700 flex items-center justify-center shrink-0">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-full py-4 bg-emerald-700 hover:bg-emerald-800 text-white font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 transition-all cursor-pointer shadow-xs active:scale-95 rounded-lg"
              >
          ...
          <div id="form-kontak" className="lg:col-span-7 bg-white border border-slate-200 rounded-xl p-8 sm:p-10 shadow-xs">
            {submitted ? (
              <div className="text-center py-12 space-y-4">
                ...
                <h3 className="text-2xl font-black uppercase tracking-tight text-[#0B2F64]">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-blue-700 hover:bg-blue-800 text-white text-xs font-bold uppercase tracking-wider transition-colors cursor-pointer rounded-lg"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3.5 py-3 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-hidden focus:border-blue-600 focus:bg-white transition-colors"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3.5 py-3 text-sm text-slate-900 focus:outline-hidden focus:border-blue-600 focus:bg-white transition-colors"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3.5 py-3 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-hidden focus:border-blue-600 focus:bg-white resize-none transition-colors"
                  ></textarea>
                </div>

                <button
                  type="submit"
                  className="w-full py-4 bg-blue-700 hover:bg-blue-800 active:scale-95 text-white font-bold text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2 cursor-pointer shadow-sm rounded-lg"
                >
