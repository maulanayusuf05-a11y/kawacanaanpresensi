      ...
      >
        ...
        <div className="bg-slate-100 px-6 py-3 border-b border-slate-200 flex items-center gap-2 overflow-x-auto text-[11px] font-bold uppercase tracking-wider">
          <button
            ...
            className={`px-4 py-2 rounded flex items-center gap-2 transition-all cursor-pointer ${
              activeTab === 'scan'
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
                ...
                <div className="md:col-span-6 bg-white p-5 rounded-xl border border-slate-200 space-y-3 shadow-xs">
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span className="text-[9px] text-indigo-700 bg-indigo-50 border border-indigo-100 font-bold px-2 py-0.5 rounded uppercase tracking-wider">
                  ...
                  <div className="relative aspect-4/3 bg-slate-950 rounded-lg border-2 border-dashed border-slate-700 flex flex-col items-center justify-center p-4 overflow-hidden group">
                    <div className="absolute inset-x-8 top-1/4 bottom-1/4 border-2 border-indigo-400 rounded pointer-events-none">
                      ...
                      <div className="w-full h-0.5 bg-indigo-400 shadow-[0_0_10px_#6366f1] animate-pulse"></div>
                    </div>

                    <QrCode className="w-16 h-16 text-slate-700 mb-2 group-hover:text-indigo-400/50 transition-colors" />
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-[10px] text-slate-500">
                              NISN: {student.nisn} • <span className="text-indigo-700 font-semibold">{student.className}</span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="px-2.5 py-1 bg-slate-900 hover:bg-indigo-600 text-white rounded text-[10px] font-bold uppercase tracking-wider transition-colors cursor-pointer"
                          >
                            Scan Now
                          </button>
                        </div>
              ...
              <div className="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-2xs">
                <div className="p-4 bg-slate-50 border-b border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button className="px-3 py-1.5 bg-slate-900 hover:bg-indigo-600 text-white rounded text-[10px] font-bold uppercase tracking-wider flex items-center gap-1.5 cursor-pointer">
                    ...
                    <tbody className="divide-y divide-slate-100 text-xs">
                      <tr className="hover:bg-slate-50/80">
                        ...
                        <td className="p-3 text-right">
                          <span className="text-indigo-600 hover:text-indigo-800 font-bold uppercase tracking-wider text-[10px] cursor-pointer">
                      ...
                      <tr className="hover:bg-slate-50/80">
                        ...
                        <td className="p-3 text-center text-indigo-700 font-bold">96.7%</td>
                        <td className="p-3 text-right">
                          <span className="text-indigo-600 hover:text-indigo-800 font-bold uppercase tracking-wider text-[10px] cursor-pointer">
                            {lang === 'ID' ? 'Rincian →' : 'Details →'}
                          </span>
        ...
        <div className="bg-slate-100 px-6 py-4 border-t border-slate-200 flex items-center justify-between text-xs text-slate-600">
          ...
          <button
            onClick={onClose}
            className="px-5 py-2.5 bg-slate-900 hover:bg-indigo-600 text-white rounded text-xs font-bold uppercase tracking-widest transition-all cursor-pointer shadow-xs"
          >
