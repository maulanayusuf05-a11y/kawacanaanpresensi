...
const MainAppContent: React.FC = () => {
  ...
  if (showLanding && (!currentUser || activeView === 'login')) {
    return (
      <>
  ...
  if (isSelectingWorkspace && activeView !== 'login') {
    return (
      <div className="min-h-screen bg-[#F8FAFC]">
